...
function t1(min, max) {
  ...
  min = Math.ceil(min);
  max = Math.floor(max);
  out1.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min; //Максимум и минимум
}
...
function t2(min, max, block) {
    min = Math.ceil(min);
    max = Math.floor(max);
    block.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min; //Максимум и минимум
}
...
function t3(min, max) {
    min = Math.ceil(min);
    max = Math.floor(max);
    out3.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min; //Максимум и минимум
}
...
function t8(block, text) {
    ...
    block.innerHTML = result.toLowerCase()
}
...
function t12(...rest) {
  console.log(rest)
  out12.innerHTML = rest.reduce((acc, current) => acc + current);
}
