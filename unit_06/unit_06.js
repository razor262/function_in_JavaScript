...
function t1() {
    return this.textContent = 'work';
}
t1.call(document.querySelector('.out-1'))
//console.log(t1.call(document.querySelector('.out-1')))
...
// Task 11
// C помощью bind создайте функцию t11, которая основана на функции t1 
// но контекст - out-11. Запустите эту функцию.

const t11 = t1.bind(document.querySelector('.out-11'))
t11()

// Task 12
// C помощью bind создайте функцию t12, которая основана на функции max
// но контекст - out-12. Запустите эту функцию c числами 11, 88.
